...
<div class="call-to-action">
  ...
  <p>Sign up to receive seminar links, reminders, and announcements about future Bioc Africa activities.
.</p>
...
![](images/intro-kevin.png){width="50%" fig-alt="Bioconductor Africa introductory session poster"}
...
The Bioconductor Africa Seminar Series is supported by the Bioconductor community and is funded in part by the Chan Zuckerberg Initiative through the **Essential Open Source Software for Science (EOSS) Cycle 6** programme.

This work is part of Bioconductor’s broader efforts to expand global training, community engagement, and capacity building.
