...
.hero--full img{
  ...
  height:auto;
  object-fit:contain;          /* no cropping; entire photo visible */
}


/* Optional: limit the max size so it doesn't dominate on large screens */
@media (min-width: 992px){
  .hero--full img{ max-height: 720px; }   /* tweak 640–800px to taste */
}
...
![](images/gbios-hero-full.jpeg){fig-alt="Full front view of GBioS showing the Welcome sign" fig-align="center" loading="lazy"}
:::
