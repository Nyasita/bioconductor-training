...
A single registration covers the full week of sessions.  

➡️ [**Register in the application form**](https://forms.gle/hUa1xpA38Ajahsrs8).    

[Download the workshop flyer (PDF)](Bioconductor Poster - Addis.pdf).


We welcome participants who are keen to develop their bioinformatics skills with a focus on genomic data analysis.
...
<div style="display: flex; justify-content: center; align-items: center; width: 100%; max-width: 1200px; margin: 10px auto;">
  <img src="images/logos/BETin-logo.png" alt="BETin Logo" style="height: 80px; margin: 0 20px;">
  <img src="images/logos/IITA-Logo.png" alt="IITA Logo" style="height: 80px; margin: 0 20px;">
  <img src="images/logos/ul-logo.jpg" alt="UL Logo" style="height: 80px; margin: 0 20px;">
  <img src="../../images/bioconductor-logo.svg" alt="Bioconductor Logo" style="height: 80px; margin: 0 20px;">
  <img src="images/logos/czi-logo.jpg" alt="CZI Logo" style="height: 80px; margin: 0 20px;">
</div>
