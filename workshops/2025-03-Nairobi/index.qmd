...
<div style="display: flex; flex-direction: column; align-items: center;">
  <a href="https://linkedin.com/in/lgatto/" target="_blank" style="display: flex; align-items: center; gap: 5px; text-decoration: none; color: inherit;">
...
<div style="display: flex; flex-direction: column; align-items: center;">
  <a href="https://linkedin.com/in/laurah-ondari-749175b6/" target="_blank" style="display: flex; align-items: center; gap: 5px; text-decoration: none; color: inherit;">
    <img src="https://cdn.jsdelivr.net/npm/simple-icons@v8/icons/linkedin.svg" width="18px"> LinkedIn
  </a>
...
<div style="display: flex; flex-direction: column; align-items: center;">
  <a href="https://almeidasilvaf.github.io/" target="_blank" style="display: flex; align-items: center; gap: 5px; text-decoration: none; color: inherit;">
    🌐 Website
  </a>
...
<div style="display: flex; justify-content: center; align-items: center; width: 100%; max-width: 1200px; margin: 20px auto;">
  <img src="images/logos/czi-logo.jpg" alt="CZI Logo" style="height: 100px; margin-right: 20px;">
  <img src="../../images/bioconductor-logo.svg" alt="Bioconductor Logo" style="height: 100px; margin: 0 20px;">
  <img src="images/logos/IITA-Logo.png" alt="IITA Logo" style="height: 100px; margin-left: 20px;">
</div>
